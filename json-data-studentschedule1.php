...
<?php
/*
 * Following code will list all the modules on a course for student
 */
...
$sql_query = "SELECT studentTable.moduleNo2,studentTable.moduleNo1, moduleTable.moduleName, moduleTable.time,moduleTable.room
FROM studentTable
INNER JOIN moduleTable  ON moduleTable.moduleNo=studentTable.moduleNo1 OR moduleTable.moduleNo=studentTable.moduleNo2
WHERE studentTable.lastName='Frog';";
//INNER JOIN moduleTable ON moduleTable.moduleNo=studentTable.moduleNo2;
//WHERE studentTable.lastName='Cullen'
