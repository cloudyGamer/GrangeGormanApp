...
$sql_query = "SELECT lecturerTable.moduleNo2,lecturerTable.moduleNo1, studentTable.firstName AS studentName, studentTable.lastName AS studentLastName
FROM lecturerTable
INNER JOIN studentTable  ON studentTable.moduleNo1=lecturerTable.moduleNo1
